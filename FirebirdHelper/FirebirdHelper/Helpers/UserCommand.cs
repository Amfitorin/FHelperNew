...
{
	public class UserCommand : ModelBase ,ICommand
	{
		public UserCommand(Action execute = null, Func<object, bool> canExecuteHandler = null)
		{
			ExecuteHandler = execute != null ? new Action<object>(_ => execute()) : (_ => { });
			CanExecuteHandler = canExecuteHandler;
		}
		public UserCommand(Action<object> execute, Func<object, bool> canExecuteHandler = null)
		{
